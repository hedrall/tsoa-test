(() => {
  ...
  // generated/client/api/default-api.ts
  var import_axios2 = __toModule(require_axios2());

  // generated/client/base.ts
  var import_axios = __toModule(require_axios2());
  var BASE_PATH = "http://localhost/v1".replace(/\/+$/, "");
  var BaseAPI = class {
  ...
  var createRequestFunction = function(axiosArgs, globalAxios3, BASE_PATH2, configuration) {
    return (axios = globalAxios3, basePath = BASE_PATH2) => {
      const axiosRequestArgs = __spreadProps(__spreadValues({}, axiosArgs.options), { url: ((configuration == null ? void 0 : configuration.basePath) || basePath) + axiosArgs.url });
  ...
  // frontend/main.ts
  var client = new DefaultApi(new Configuration({
